...
if [ "$outfile" ]; then
    ...
    echo -e "#########################################################" >> $outfile
    echo -e "Methodology Used:" >> $outfile
    echo -e "#########################################################" >> $outfile
    echo -e "  1. Operating System" >> $outfile
    echo -e "  2. Users, Services & Applications" >> $outfile
    echo -e "  3. Environmental" >> $outfile
    echo -e "  4. Jobs & Tasks" >> $outfile
    echo -e "  5. Communications & Networking" >> $outfile
    echo -e "  6. Confidential Information & Interesting Files" >> $outfile
    echo -e "  7. Possible Exploit Code" >> $outfile
    ...
    echo -e "\e[00;34mMethodology Used:\e[00m"
    echo -e "\e[00;34m#########################################################\e[00m"
    echo -e "\e[00;34m  1. Operating System\e[00m"
    echo -e "\e[00;34m  2. Users, Services & Applications\e[00m"
    echo -e "\e[00;34m  3. Environmental\e[00m"
    echo -e "\e[00;34m  4. Jobs & Tasks\e[00m"
    echo -e "\e[00;34m  5. Communications & Networking\e[00m"
    echo -e "\e[00;34m  6. Confidential Information & Interesting Files\e[00m"
    echo -e "\e[00;34m  7. Possible Exploit Code\e[00m\n"
...
# INTERESTING FILES / CONFIDENTIAL INFORMATION
# --------------------------------------------
